              ...
              <form>
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="w-full bg-gray-1 dark:bg-bg-cardDark border border-gray-3 dark:border-border-dark outline-none rounded-md placeholder:text-dark-4 dark:placeholder:text-text-secondary-dark text-dark dark:text-text-primary-dark py-3 px-5"
                  />
                  <button
                    type="submit"
