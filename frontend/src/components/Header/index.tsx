...
const Header = () => {
  ...
  const options = [
    { label: t.header.allCategories, value: "0" },
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-white dark:bg-bg-cardDark transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow"
      }`}
    >
        ...
        >
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 dark:bg-bg-cardDark !border-l-0 border border-gray-3 dark:border-border-dark py-2.5 pl-4 pr-10 outline-none ease-in duration-200 text-text-primary dark:text-text-primary-dark placeholder:text-text-secondary dark:placeholder:text-text-secondary-dark"
                    />
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <span className="block text-2xs text-dark-4 dark:text-text-secondary-dark uppercase">
                  {t.header.support}
                </span>
                <p className="font-medium text-custom-sm text-dark dark:text-text-primary-dark">
                  (+965) 7492-3477
                </p>
              </div>
            </div>
            ...
            {/* <!-- divider --> */}
            <span className="hidden xl:block w-px h-7.5 bg-gray-4 dark:bg-border-dark"></span>

            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              {/* Theme Toggle Button */}
              <button
                onClick={toggleTheme}
                className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-3 dark:hover:bg-bg-cardDark hover:border hover:border-gray-4 dark:hover:border-border-dark transition-all duration-200"
                ...
                {isAuthenticated ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-medium text-custom-sm text-red-600 dark:text-red-400">
              ...
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-text-primary-dark rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${
                        !navigationOpen && "!w-full delay-300"
                      }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-text-primary-dark rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${
                        !navigationOpen && "!w-full delay-400"
                      }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-text-primary-dark rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                      className={`block bg-dark dark:bg-text-primary-dark rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full ${
                        !navigationOpen && "!h-0 delay-[0] "
                      }`}
                    ></span>
                    <span
                      className={`block bg-dark dark:bg-text-primary-dark rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${
      ...
      <div className="border-t border-gray-3 dark:border-border-dark">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            {/* <!--=== Main Nav Start ===--> */}
                ...
                navigationOpen &&
                `!visible bg-white dark:bg-bg-cardDark shadow-lg border border-gray-3 dark:border-border-dark !h-auto max-h-[400px] overflow-y-scroll rounded-md p-5`
              }`}
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {getMenuData(language).map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-[3px] before:bg-blue dark:before:bg-primary-dark before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full "
                      >
                        <Link
                          href={menuItem.path}
                    className={`hover:text-blue dark:hover:text-primary-dark text-custom-sm font-medium text-dark dark:text-text-primary-dark flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <a
                    href="#"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark dark:text-text-primary-dark hover:text-blue dark:hover:text-primary-dark"
                  >
                    <svg
                      className="fill-current"
                      width="16"
