...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-white dark:bg-bg-main-dark">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark dark:text-text-primary-dark">
              Help & Support
            </h2>

            <ul className="flex flex-col gap-3 text-body dark:text-text-secondary-dark">
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5 hover:text-blue dark:hover:text-primary-dark transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                className="flex text-body dark:text-text-secondary-dark ease-out duration-200 hover:text-blue dark:hover:text-primary-dark"
              >
                <svg
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5 text-body dark:text-text-secondary-dark">
              <li>
                <a className="ease-out duration-200 hover:text-blue dark:hover:text-primary-dark" href="#">
                  {t.account.title}
                </a>
              </li>
              <li>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark dark:text-text-primary-dark lg:text-right">
              Download App
            </h2>

            <p className="lg:text-right text-custom-sm mb-4 text-body dark:text-text-secondary-dark">
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-dark dark:bg-gray-7 ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <a
                  className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-blue ease-out duration-200 hover:bg-blue-dark"
                  href="#"
                >
                  <svg
                    className="fill-current"
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-gray-1 dark:bg-bg-cardDark">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark dark:text-text-primary-dark font-medium">
              &copy; {year}. {t.footer.copyright}
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium text-dark dark:text-text-primary-dark">We Accept:</p>
