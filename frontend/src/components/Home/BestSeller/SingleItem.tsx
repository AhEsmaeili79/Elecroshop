...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-gray-1 dark:bg-gray-2 min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          <div className="flex items-center justify-center gap-2.5 mb-2">
            ...
            <p className="text-custom-sm text-dark dark:text-dark">({item.reviews})</p>
          </div>

          <h3 className="font-medium text-dark ease-out duration-200 hover:text-blue dark:hover:text-primary-dark mb-1.5">
        ...
        <div className="absolute end-0 bottom-0 translate-x-full product-action-buttons u-w-full flex flex-col gap-2 p-5.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:translate-x-0 ease-linear duration-300 transition-all">
          <button
            onClick={() => {
            ...
            id="bestOne"
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark dark:text-dark bg-white dark:bg-gray-3 hover:text-white hover:bg-blue dark:hover:bg-blue"
          >
            <svg
