        ...
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-dark text-2xl">{t.cart.title}</h2>
              <button className="text-blue">{t.common.delete}</button>
            </div>
                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    <div className="min-w-[400px]">
                      <p className="text-dark">{t.common.view}</p>
                    </div>
                    ...
                    <div className="min-w-[275px]">
                      <p className="text-dark">{t.product.quantity}</p>
                    </div>
                    ...
                    <div className="min-w-[50px]">
                      <p className="text-dark text-right">{t.common.delete}</p>
                    </div>
                  </div>
