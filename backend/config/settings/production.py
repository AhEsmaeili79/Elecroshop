...
# Production settings - DEBUG must be False
DEBUG = False

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '95.216.121.250').split(',')

# Production Django apps only
DJANGO_APPS = [
...
# ASGI Application for production
...
# REST Framework Configuration - Optimized for production
REST_FRAMEWORK = {
...
# Email configuration (placeholder - configure as needed)
